...
if(isset($_GET["sign"]))
{
    ...
    if($sign=="out")
    {
        unset($_SESSION["tours_data_2020"]);
...
if(isset($_SESSION['tours_data_2020']) == false){
    header("Location:../login.php");
}else{
    ?>
                                ...
                                $sql5="SELECT * from hotel_tour where username='$_SESSION[tours_data_2020]'";
...
<head>
    ...
    <!-- Title Page-->
    <title>East Africa Reservation :: Tours</title>

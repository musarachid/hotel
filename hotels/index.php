...
if(isset($_GET["sign"]))
{
    ...
    if($sign=="out")
    {
        unset($_SESSION["hotel_tours_data_2020"]);
...
if(isset($_SESSION['hotel_tours_data_2020']) == false){
    header("Location:../login.php");
}else{
    ?>
                                ...
                                $sql5="SELECT * from hotel_tour where username='$_SESSION[hotel_tours_data_2020]'";
                                $result5=$conn->query($sql5);


                                while ($row5 = $result5->fetch_assoc()) {
                                $account_id=$row5['hotel_id'];
                                $username=$row5['username'];
                                $name=$row5['hotel_name'];
                                $country=$row5['origin'];
                                $city=$row5['location'];
                                $stars=$row5['standard'];
                                $boss=$row5['manager'];
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                                        ...
                                                        ?>
                                           <img src="hotels_profile_data/<?php echo $fileName ?>" alt="<?php echo $username ?>" />
                                        </div>
                                        <div class="content">
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="index.php?payment">
                                <i class="fas fa-picture-o"></i>Payment Details</a>
                        </li>                      
                    ...
                    <ul class="list-unstyled navbar__list"> 
                        ...
                        <li>
                            <a href="index.php?manage_room">
                                <i class="fas fa-tasks"></i>Rooms Management</a>
                        </li>
                        <li>
                            <a href="#">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-file-text"></i>Reservations</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="index.php?agent">Pending</a>
                                </li>
                                <li>
                                    <a href="register.html">Finished</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fas fa-archive"></i>Reports</a>
                        </li>
                    </ul>
                </nav>
            </div>

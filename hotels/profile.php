            ...
            <div class="card">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2"> Hotel Card</h3>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        ?>
                                                        <img class="align-self-center  mr-3" src="hotels_profile_data/<?php echo $fileName ?>" alt="<?php echo $username ?>" >
                                                    </div>
                                                </div>
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        <p><strong>Hotel Name</strong>  <?php echo $name ?></p>
                                                    </div>
                                                    ...
                                                    <div class="input-group">
                                                        <p><strong>Hotel Manager</strong>  <?php echo $boss ?></p>
                                                    </div>

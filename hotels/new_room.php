 ...
 <div class="row" id="loader_general_admin2">
                            <div class="col-md-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                    <div class="card-header">New Room Details</div>
                                    <div class="card-body">
                                        <form action="#/" onsubmit="new_room_data();return false;"  method="post" novalidate="novalidate">
                                                    ...
                                                    <div class="row">
                                                      ...
                                                      <div class="col-md-3">
                                                        <div class="input-group">
                                                            <img class="align-self-center mr-3" src="hotels_profile_data/avatar-06.jpg" id="room_photo_1" alt="Card image cap" width="200px" height="230px">
                                                            <br><br>
                                                      ...
                                                      <div class="col-md-3">
                                                        <div class="input-group">
                                                            <img class="align-self-center mr-3" src="hotels_profile_data/avatar-06.jpg" id="room_photo_2" alt="Card image cap" width="200px" height="230px">
                                                            <br><br>
                                                      ...
                                                      <div class="col-md-3">
                                                        <div class="input-group">
                                                            <img class="align-self-center mr-3" src="hotels_profile_data/avatar-06.jpg" id="room_photo_3" alt="Card image cap" width="200px" height="230px">
                                                            <br><br>
                                                      ...
                                                      <div class="col-md-3">
                                                        <div class="input-group">
                                                            <img class="align-self-center mr-3" src="hotels_profile_data/avatar-06.jpg" id="room_photo_4" alt="Card image cap" width="200px" height="230px">
                                                            <br><br>
                                            ...
                                            <div>
                                                <button id="payment-button" type="submit" class="btn btn-lg btn-primary btn-block">
                                                    ...
                                                    <span id="payment-button-amount">Save New Room</span>
                                                </button>
                                            </div>
                                        </form>
                                    </div>

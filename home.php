                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12">
                                <div class="welcome-text text-center">
                                    ...
                                    <h2 data-animation="fadeInLeft" data-delay="500ms">Welcome To EAC reservation</h2>
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12">
                                <div class="welcome-text text-center">
                                    ...
                                    <h2 data-animation="fadeInUp" data-delay="500ms">Welcome To EAC reservation</h2>
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12">
                                <div class="welcome-text text-center">
                                    ...
                                    <h2 data-animation="fadeInDown" data-delay="500ms">Welcome To EAC reservation</h2>
        ...
        <div class="hotel-search-form-area">
            <div class="container-fluid">
                <div class="hotel-search-form">
                    <form action="index.php?room" method="post">
                        <div class="row justify-content-between align-items-end">
                        <div class="col-6 col-md-2 col-lg-3">
                                <label for="checkIn">Location</label>
                                <input type="text" class="form-control" placeholder="where are you looking for?">
                            </div>
                            <div class="col-6 col-md-2 col-lg-3">
            ...
            <div class="rooms-slides owl-carousel">
                ...
                <div class="single-room-slide d-flex align-items-center">
                    ...
                    <div class="room-content">
                        ...
                        <a href="index.php?room_view" class="btn roberto-btn mt-30" data-animation="fadeInUp" data-delay="700ms">View Details</a>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post-area mb-100 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <!-- Post Meta -->
                        <div class="post-meta">
                            <a href="#" class="post-catagory"> Kigali Serena Hotel </a>
                        </div>
                        <!-- Post Title -->
                        <a href="#" class="post-title">Standard Double or Twin Room </a>
                        <p>2 twin beds • 1 king bed </p>
                        <h6>125$ <span>/ Day</span></h6>
                        <a href="index.php?room_view" class="btn roberto-btn mt-30">View Details</a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post-area mb-100 wow fadeInUp" data-wow-delay="500ms">
                        ...
                        <!-- Post Meta -->
                        <div class="post-meta">
                            <a href="#" class="post-catagory"> 2000 Hotel Downtown Kigali </a>
                        </div>
                        <!-- Post Title -->
                        <a href="#" class="post-title">King Room with Mountain View</a>
                        <p>M 1 king bed</p>
                        <!-- <p>Only 2 rooms like this left on our site</p> -->
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-post-area mb-100 wow fadeInUp" data-wow-delay="700ms">
                        ...
                        <!-- Post Meta -->
                        <div class="post-meta">
                            <a href="#" class="post-catagory">  The Nest Opens in new window </a>
                        </div>
                        <!-- Post Title -->
                        <a href="#" class="post-title">Deluxe Double Room </a>
                        <p>1 queen bed </p>
                        <h6>53$ <span>/ Day</span></h6>
                        <a href="index.php?room_view" class="btn roberto-btn mt-30">View Details</a>
                    </div>
                </div>

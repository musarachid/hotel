...
<head>
    ...
    <!-- Title -->
    <title>East Africa Reservation</title>
                ...
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="robertoNav">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav">
                                    <li><a href="./contact.html"><button type="submit" class="form-control btn roberto-btn w-100">Tours & activities </button></a></li>
                                    <li><a href="index.php?home">Home</a></li>
                                    <li><a href="index.php?room">Rooms</a></li>
                                    <li><a href="register.php">add hotel</a></li>

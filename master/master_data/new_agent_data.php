...
$query=$conn->query("SELECT username from agent where username='$name'");
if($query->num_rows == 1){
?>
<div class="sufee-alert alert with-close alert-danger alert-dismissible fade show">
    <span class="badge badge-pill badge-danger">Error</span>
        Sorry the <strong><?php echo "$name"; ?></strong> is Already Registered.
...
$sql="INSERT INTO agent( `username`, `password`, `contact`)
                    VALUE('$name','$pass','$tel')";
                    if ($conn->query($sql)==TRUE) {
                        ?>
                        <div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
                            <span class="badge badge-pill badge-success">Done</span>
                                You have Succefully created New Agent Account.

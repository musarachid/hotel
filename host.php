...
<head>
  ...
  <!-- Title -->
    <title>East Africa Reservation::Hotels & Tours</title>
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="#/" onsubmit="new_hotel_tours();return false;" method="post">
                                ...
                                <div class="form-group">
                                    <label>E-mail</label>
                                    <input class="au-input au-input--full" type="email" id="email" name="email" placeholder="Your Email" required autofocus >
                                </div>
                                <div class="form-group">
                                    <label>Contact</label>
                                    <input class="au-input au-input--full" type="number" id="contact" name="contact" placeholder="Your Contact" required autofocus >
                                </div>
                                <div class="form-group">
                                    <label>Category</label>
                                        <select  id="role" id="role" class="form-control">

                                                       <option value="">Please Select Category </option>
                                                       <option value="hotel">Hotel Registration </option>
                                                       <option value="tours">Tour Registration </option>
                                                    </select>
                                </div>
                                <div class="form-group">

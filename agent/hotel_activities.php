                <div class="container-fluid">
                    <div id="hotel_invitation_complete_message" style="position:fixed;z-index:500;margin-top:-2%;"></div>
                      ...
                      <div class="row" id="loader_general_admin2">
                            ...
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Hotel Invitation Management</h3>
                                    ...
                                    <table class="table table-data2" id="Table1">
                                        <thead>
                                            <tr>
                                               ...
                                               <?php
                                                ...
                                                $sql5="SELECT * from hotel_tour WHERE role='hotel' and hotel_approv=0 ";
                                        ...
                                        <tbody>
                                            <tr class="tr-shadow">
                                                ...
                                                <td><?php echo $a ?></td>
                                                <td>
                                                   <img style="height:60px;width: 120px;float: left;" src="../hotels/hotels_profile_data/<?php echo $fileName; ?>" />
                                                </td>
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <form action="#/" onsubmit="accept_hotel_to_work();return false;" method="post" >
